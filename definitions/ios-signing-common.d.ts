...
declare module 'ios-signing-common/ios-signing-common' {
    ...
    */
     ...
     * @param privateKeyName the name of P12 private key
     * @param useKeychainIfExists Pass false to delete and recreate a preexisting keychain
     */
    export function installCertInTemporaryKeychain(keychainPath: string, keychainPwd: string, p12CertPath: string, p12Pwd: string, privateKeyName: string, useKeychainIfExists: boolean): Promise<void>;
